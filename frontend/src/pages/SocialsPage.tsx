  ...
  const socials = [
    {
      ...
      color: 'from-blue-600/40 to-blue-700/40',
      hoverColor: 'hover:from-blue-600/60 hover:to-blue-700/60',
    },
    {
      name: 'TikTok',
      ...
      color: 'from-cyan-400/40 via-fuchsia-500/40 to-red-500/40',
      hoverColor: 'hover:from-cyan-400/60 hover:via-fuchsia-500/60 hover:to-red-500/60',
    },
    {
      name: 'YouTube',
      ...
      hoverColor: 'hover:from-red-600/60 hover:to-red-700/60',
    },
    {
      name: 'Discord',
      ...
      color: 'from-indigo-600/40 to-indigo-700/40',
      hoverColor: 'hover:from-indigo-600/60 hover:to-indigo-700/60',
    },
    {
      name: 'Instagram',
      ...
      color: 'from-pink-600/40 to-purple-600/40',
      hoverColor: 'hover:from-pink-600/60 hover:to-purple-700/60',
    },
    {
      name: 'X (Twitter)',
      ...
      hoverColor: 'hover:from-slate-700/60 hover:to-slate-800/60',
    },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="w-16 h-16 bg-primary-100 dark:bg-gradient-to-br dark:from-blue-500 dark:to-blue-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg dark:shadow-blue-500/40">
            <Users className="w-8 h-8 text-primary-600 dark:text-text-dark-highlight" />
          </div>
          ...
          <p className="text-lg text-text-secondary dark:text-text-dark-secondary max-w-2xl mx-auto">
            Follow me on social media for updates, gaming content, and more!
          </p>
        </motion.div>
        ...
        >
          {socials.map((social, index) => (
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className={`card group cursor-pointer bg-gradient-to-r ${social.color} ${social.hoverColor} backdrop-blur-md border border-white/10 transition-all duration-300`}
            >
        ...
        >
          ...
          <p className="text-text-secondary dark:text-text-dark-secondary mb-6">
            Get the latest updates on gaming, 8 Ball Pool tips, and more by following me on your favorite platform!
          </p>
          <div className="flex items-center justify-center space-x-2 text-sm text-text-muted dark:text-text-dark-muted">
            <Users className="w-4 h-4" />
            <span>Join the community and never miss an update!</span>
          </div>
        </motion.div>
      </div>
    </div>
